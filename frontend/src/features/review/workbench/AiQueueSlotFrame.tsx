...
export type AiQueueWorkbenchSlotId = "toolbar" | "queue" | "content" | "insight";

export interface AiQueueSlotFrameControls {
  editMode: boolean;
...
export function AiQueueSlotFrame({
  slotId,
  title,
  description,
  env,
  ...
  slotId: AiQueueWorkbenchSlotId;
  title: string;
  description: string;
  env: WorkbenchRenderContext;
  controls: AiQueueSlotFrameControls;
  flush?: boolean;
  children: ReactNode;
}) {
